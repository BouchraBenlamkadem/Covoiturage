...
<script type="text/javascript">
  ...
  <body>
    ...
    <!--          <li class="nav-item"><a href="about.html"style="color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">A propos</a></li> -->
              ...
              <li class="nav-item"style="width: 180px;"><a href="/nouveau"style="width: 100%;color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">Proposer un trajet</a></li>
              
<!-- Authentication Links begin-->
              @guest
               <li class="nav-item"><a href="register"style="color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">Inscription</a></li>
              <li class="nav-item"><a href="login"style="color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">Connexion</a></li>
              @endguest
@auth
    <li class="nav-item"><a href="profil"style="color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">Profil</a></li>
              <li class="nav-item"><a href="logout"style="color: #f9be37 ;text-shadow: 0 0 1px #777777 , 0 0 2px #ffc33d;font-weight: 900;" class="nav-link">Déconnexion</a></li>
@endauth
